...
<h3>CATEGORIE DEPENSE</h3>


<?php 

	$req = $cnx->query("SELECT * FROM categorie_depense");
	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<a href="assets/include/script.php?id_cat_sup=<?=$valeur['id_cat']?>" class="btn btn-danger btn-sm">supprimer</a>
...
<div class="modal fade" id="modal_ajouter" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <form action="assets/include/script.php" method="POST">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" type="submit" class="btn btn-success" name="btn_ajouter_cat">Valider</button>
      </div>
      </form>
    </div>
  </div>
...
<div class="modal fade" id="modal_modifier" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <form action="assets/include/script.php" method="POST">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Annuler</button>
        <button type="submit" type="submit" class="btn btn-success" name="btn_modifier_cat">Valider</button>
      </div>
      </form>
    </div>
  </div>
